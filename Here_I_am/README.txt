#Here I am
		...
		|:----:|:-----------------------:|:---------------------:|:------------------:|:-----------------:|
Login:		|  1.  |invalid username         |ask to login again     |ask to login again  | OK                |
		|2.    |username and password doesnt match|ask to login again|ask to login again|OK		  |
Register:	|3.    |username already present |ask to choose another username|does not accept registeration|OK |
		|4.    |passwords doesnt match   |does not accept registeration |does not accept registeration|OK |
Reminder:	|5.    |invalid name of reminder | ask to enter again    | ask to enter again |OK                 |  
